...
We first use the `rating` matrix as the main data matrix $Y$, and the `genre` matrix as the auxiliary matrix $X$.
We then proceed to fit the MFAI model with top three factors.
